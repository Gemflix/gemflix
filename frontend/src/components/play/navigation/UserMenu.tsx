    ...
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 mt-4 w-64 bg-[#121418] rounded-xl shadow-2xl border border-white/10 py-2 z-50 origin-top-right animate-in fade-in zoom-in-95 duration-200">
          ...
          <Link href="/profiles" className="flex px-4 py-2.5 text-sm text-gray-300 hover:bg-white/5 hover:text-white items-center gap-3">
          ...
          <Link href="/settings" className="flex px-4 py-2.5 text-sm text-gray-300 hover:bg-white/5 hover:text-white items-center gap-3">
            <svg className="w-4 h-4 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <button 
            ...
            className="flex w-full text-left px-4 py-2.5 text-sm text-red-400 hover:bg-white/5 hover:text-red-300 items-center gap-3"
          >
