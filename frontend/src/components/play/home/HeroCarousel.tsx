            ...
            <div className="w-full px-6 md:px-12 lg:px-20 flex justify-between items-center gap-8">
              ...
              <div className="flex-1 max-w-2xl lg:max-w-3xl transform transition-all duration-700 opacity-100 translate-y-0">
                ...
                <div className="pt-4 md:pt-6 flex flex-wrap items-center gap-3 md:gap-4">
                  ...
                  <button className="inline-flex items-center gap-2.5 bg-gray-900/60 hover:bg-gray-800/80 text-gray-200 hover:text-white font-bold py-3.5 px-6 md:py-4 md:px-7 rounded-2xl backdrop-blur-xl border border-white/15 transition-all duration-300 hover:scale-105 active:scale-95 shadow-lg">
