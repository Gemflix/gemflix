  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Códigos Promocionales</h1>
          <p className="text-slate-400 mt-1">Crea y administra cupones de descuento.</p>
        </div>
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden min-h-[400px] flex items-center justify-center">
        <div className="text-center text-slate-500 flex flex-col items-center">
          ...
          <p>Módulo de <b>Códigos Promocionales</b> conectado.</p>
